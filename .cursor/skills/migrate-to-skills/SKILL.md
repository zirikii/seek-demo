...
description: Convert Cursor rules ("Applied intelligently") and slash commands to Agent Skills format. Use when migrating .cursor/rules/*.mdc or .cursor/commands/*.md into .cursor/skills/*/SKILL.md.
---
